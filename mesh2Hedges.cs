...
public class mesh2Hedges : MonoBehaviour {
	...
	private class medge//mesh edge for reference
	{
	...
	void CreateHalfGeometry()
	{
		...
		j=0; while (j< hedge.Length)
		{
			i=j+1;while (i< hedge.Length)
			{
				...
				if (
				//if different index but same inverse position (clone)
	...
	void Start ()
	{
		UnityMesh = this.gameObject.GetComponent<MeshFilter>().mesh;
	...
	{		
		...
		//    Debug.DrawLine(
		//	    new Vector3(UnityMesh.uv2[t.index1].x,UnityMesh.uv2[t.index1].y,0),
		//	    new Vector3(UnityMesh.uv2[t.index2].x,UnityMesh.uv2[t.index2].y,0),
		//	    Color.gray);
		//    Debug.DrawLine(
		//	    new Vector3(UnityMesh.uv2[t.index2].x,UnityMesh.uv2[t.index2].y,0),
		//	    new Vector3(UnityMesh.uv2[t.index3].x,UnityMesh.uv2[t.index3].y,0),
		//	    Color.gray);
		//    Debug.DrawLine(
		//	    new Vector3(UnityMesh.uv2[t.index3].x,UnityMesh.uv2[t.index3].y,0),
		//	    new Vector3(UnityMesh.uv2[t.index1].x,UnityMesh.uv2[t.index1].y,0),
	    ...
	    //}
		//foreach (twin tw in twinlist)
		//{
		//	Debug.DrawLine(tw.n1.pos1,tw.n1.pos2,Color.green);
		//	Debug.DrawLine(tw.n2.pos1*2,tw.n2.pos2*2,Color.yellow);
		//	print(tw.n2.pos1);
		//}
		//foreach (medge e in sololist)
		//{
		//	if (e != null) Debug.DrawLine(e.pos1,e.pos2,Color.blue);
		//}
		//foreach (medge e in singlelist)
		//{
		//	if (e != null) Debug.DrawLine(e.pos1,e.pos2,Color.green);
		//}
		foreach (half.edge e in hedge)
		{
			if (e != null 
				...
				Debug.DrawLine(e.twinmedge.pos1,e.twinmedge.pos2,Color.green);
		}
		//iterator++; if (iterator >= UnityMesh.vertices.Length) iterator = 0;
		//Debug.DrawLine(UnityMesh.vertices[iterator],UnityMesh.normals[iterator],Color.magenta);
    }
